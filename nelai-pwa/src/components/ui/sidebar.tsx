  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* El desplazamiento del contenido lo maneja `SidebarInset` (padding-left), no este spacer. */}
        <div className="w-0" />
        <div
          className={cn(
  ...
  return (
    <main
      ...
      className={cn(
        ...
        // En `variant=inset` el sidebar colapsado (icon) incluye padding extra (p-2) dentro de un contenedor
        // cuya `w` se calcula con `theme(spacing.4)` + borde. Si no lo reflejamos aquí, el contenido queda por debajo.
        "md:peer-data-[state=collapsed]:peer-data-[variant=inset]:pl-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)]",
